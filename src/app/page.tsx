...
const profileFormSchema = z.object({
  ...
  workPlace: z.string().min(2, {
    message: 'Workplace must be at least 2 characters.',
  }),
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Where you work</FormLabel>
                        <FormControl>
                          <Input placeholder="Your company or university" {...field} />
                        </FormControl>
                         <FormDescription>
                          This helps find compatible roommates.
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
